...
class RegularStream(nn.Module):
    def __init__(self, n_classes):
        ...
        self.net = BiSeNetV2(n_classes)

    def forward(self, x):
        output = self.net(x)
        x, res1, res2, res3, res4 = output["out"], output["aux_c2"], output["aux_c3"], output["aux_c4"], output["aux_c5_4"]
...
class GatedSCNN(nn.Module):
    def __init__(self, backbone_type='resnet50', num_classes=6):
        super().__init__()

        self.regular_stream = RegularStream(num_classes)
