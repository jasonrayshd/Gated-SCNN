...
class Cityscapes(Dataset):
    def __init__(self, split='train', crop_size=None, mean=city_mean, std=city_std, ignore_label=0):
        ...
        search_images = f"./data/vaihingen/train/cropped/images/{split}/*.png"
        search_labels = f"./data/vaihingen/train/cropped/masks/{split}/*.png"
        search_grads = f"./grad/{split}/*.png"
        search_boundaries = f"./boundary/{split}/*.png"
